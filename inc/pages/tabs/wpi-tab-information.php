...
<form enctype="multipart/form-data" method="post">
   <section class="ac-container">
      <div>
         ...
         <label for="ac-1" class='label'> عنوان ها </label>
               ...
               <table class="form-table" role="presentation">
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <input type="text" value="<?php echo wpi_get_option('invoice-cellphone', ''); ?>" class="regular-text wpi-phone-number"
                              id='wpi_services[invoice-cellphone]' name='wpi_services[invoice-cellphone]'>
                           <div>
                        ...
                        <td>
                           <input type="text" value="<?php echo wpi_get_option('invoice-mobile', ''); ?>" class="regular-text wpi-phone-number "
                              id="wpi_services[invoice-mobile]" name='wpi_services[invoice-mobile]'>
                        </td>
                     </tr>
                     <tr>
                        <th scope="row">
                        ...
                        <td>
                           <input type="text" value="<?php echo wpi_get_option('invoice-fax', ''); ?>" class="regular-text "
                              id='wpi_services[invoice-fax]' name='wpi_services[invoice-fax]'>
                        </td>
                        <th scope="row">
                           <label for="wpi_services[invoice-email]"><?php echo __('Email', WPI_LANG); ?>  </label>
                        </th>
                        <td>
                           <input type="text" value="<?php bloginfo('admin_email'); ?>" class="regular-text code"
                              id='wpi_services[invoice-email]' name='wpi_services[invoice-email]'>
                        </td>
                     </tr>
<tr>
                        ...
                        <td>
                           <input type="text" value="<?php echo wpi_get_option('invoice-urlshop', ''); ?>" class="regular-text code"
                              id='wpi_services[invoice-urlshop]' name='wpi_services[invoice-urlshop]'>
                        </td>
</tr>
                     <tr>
                        <th scope="row">
                        ...
                        <td>
                           <textarea type="text" rows='5' class="regular-text w-100" id='wpi_services[invoice-address]'
                              name='wpi_services[invoice-address]'><?php echo wpi_get_option('invoice-address', ''); ?></textarea>
                        </td>
                     </tr>
                  </tbody>
               </table>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td>
                           <div class="dv-logo-row regular-text">
                              <div class="">
                                 <label for="dv-preinvoice-logo"
                                    class="button button-primary"><?php echo __('choose New Image', WPI_LANG); ?></label>
                                 <input type="file" id="dv-preinvoice-logo" data-toggle="ImgUp"
                                    data-preview-id="dv-preinvoice-logo-preview"
                                    name="dv-preinvoice-logo" class="custom-file-input">
                                 <input type="hidden" id="dv-preinvoice-logo-def" name="dv-preinvoice-logo-def"
                                    value="<?php
                     ...
                     <tr>
                        ...
                        <td>
                           <div class="dv-logo-row regular-text">
                              <div class="">
                                 <label for="dv-preinvoice-digital-logo"
                                 ...
                                 <input type="hidden" id="dv-preinvoice-digital-logo-def" name="dv-preinvoice-digital-logo-def"
                                    value="<?php
                                       echo wpi_get_option('invoice-digital-logo' , WPI_URL.'assets/images/stamp.png'); ?>">
                              </div>
							  
							  <?php var_dump( wpi_get_option('invoice-digital-logo' , WPI_URL.'assets/images/stamp.png') ); ?>
